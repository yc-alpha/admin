...
CREATE TABLE "public"."casbin_rules" (
  ...
  "v1" character varying NOT NULL DEFAULT '',
  "v2" character varying NOT NULL DEFAULT '',
  "v3" character varying NOT NULL DEFAULT '',
  "v4" character varying NOT NULL DEFAULT '',
  "v5" character varying NOT NULL DEFAULT '',
  PRIMARY KEY ("id")
);
-- Create index "casbinrule_ptype_v0_v1_v2_v3_v4_v5" to table: "casbin_rules"
CREATE INDEX "casbinrule_ptype_v0_v1_v2_v3_v4_v5" ON "public"."casbin_rules" ("ptype", "v0", "v1", "v2", "v3", "v4", "v5");
...
CREATE TABLE "public"."roles" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "roles_tenants_roles" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "role_tenant_id_code" to table: "roles"
CREATE UNIQUE INDEX "role_tenant_id_code" ON "public"."roles" ("tenant_id", "code");
-- Set comment to column: "code" on table: "roles"
COMMENT ON COLUMN "public"."roles"."code" IS '角色编码，如 admin, tenant_admin, sales_manager';
...
COMMENT ON COLUMN "public"."roles"."is_system" IS '是否系统预置角色（系统预置的不可删除/修改code）';
-- Set comment to column: "tenant_id" on table: "roles"
...
CREATE TABLE "public"."user_roles" (
  ...
  "user_id" bigint NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "user_roles_roles_user_roles" FOREIGN KEY ("role_id") REFERENCES "public"."roles" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "user_roles_tenants_user_roles" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "user_roles_users_user_roles" FOREIGN KEY ("user_id") REFERENCES "public"."users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "userrole_role_id" to table: "user_roles"
CREATE INDEX "userrole_role_id" ON "public"."user_roles" ("role_id");
-- Create index "userrole_tenant_id" to table: "user_roles"
CREATE INDEX "userrole_tenant_id" ON "public"."user_roles" ("tenant_id");
-- Create index "userrole_user_id" to table: "user_roles"
CREATE INDEX "userrole_user_id" ON "public"."user_roles" ("user_id");
-- Create index "userrole_user_id_role_id_tenant_id" to table: "user_roles"
CREATE UNIQUE INDEX "userrole_user_id_role_id_tenant_id" ON "public"."user_roles" ("user_id", "role_id", "tenant_id");
-- Set comment to column: "expires_at" on table: "user_roles"
COMMENT ON COLUMN "public"."user_roles"."expires_at" IS '过期时间,NULL表示永久有效';
-- Set comment to column: "role_id" on table: "user_roles"
COMMENT ON COLUMN "public"."user_roles"."role_id" IS '角色ID';
-- Set comment to column: "tenant_id" on table: "user_roles"
