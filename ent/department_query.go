...
func (dq *DepartmentQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Department, init func(*Department), assign func(*Department, *Tenant)) error {
...
func (dq *DepartmentQuery) loadUserDepartments(ctx context.Context, query *UserDepartmentQuery, nodes []*Department, init func(*Department), assign func(*Department, *UserDepartment)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(userdepartment.FieldDeptID)
	}
